...
// функция подсветки якоря ссылки
function backlight(id) {$(id).style.backgroundColor='#ffff00';
$(id).children[0].classList.add("ref");
  function disable_backlight() {$(id).style.backgroundColor='transparent';
$(id).children[0].classList.remove("ref");
}
setTimeout(disable_backlight, 3000);}
